...
export function MainScreen() {
    ...
    return (
        <div id="mainScreenDiv" className="flex lg:flex-row md:flex-col sm:flex-col bg-slate-900 h-screen lg:px-24 md:px-10 sm:px-10 overflow-hidden md:overflow-y-auto sm:overflow-y-auto text-slate-400  justify-around">
